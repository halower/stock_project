...
🚨 **盈亏比硬性要求（极其重要）**：
- 止损价：通常设在当前价下方3-8%，基于关键支撑位
- 目标价：必须确保盈利空间至少是止损空间的2倍
- **盈亏比计算**：
  * 风险空间 = (当前价 - 止损价) / 当前价 × 100%
  * 盈利空间 = (目标价 - 当前价) / 当前价 × 100%
  * 盈亏比 = 盈利空间 / 风险空间
  * **必须确保盈亏比 ≥ 2:1，否则给出观望信号！**
- **示例**：当前价¥100，止损¥95（-5%），目标价必须≥¥110（+10%），盈亏比2:1
...
5. **🚨 最重要：计算盈亏比，如果<2:1，必须改为观望信号！**
6. **止损幅度通常3-8%，目标盈利必须≥止损的2倍**
''';
  }
